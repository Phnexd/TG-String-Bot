...
ERROR_MESSAGE = "Oops! An exception occurred! \n\n**Error** : {} " \
            "\n\nTell in My Support @The_Great_Friends Oh Errors 😱" \
...
async def generate_session(bot, msg, telethon=False):
    ...
    text = "**{} STRING SESSION** \n\n`{}` \n\nGenerated by @TheStringSessionBot".format("TELETHON" if telethon else "PYROGRAM", string_session)
    await client.send_message("me", text)
    await client.disconnect()
    await phone_code_msg.reply("Seccusfully {} string session. \n\nNow Check/Saved Message! \n\nBy @TheStringSessionBot".format("telethon" if telethon else "pyrogram"))
